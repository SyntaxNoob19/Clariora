...
//       print('Fetched articles: ${snapshot.docs.length}');  // Debugging line
 ...
 Future<List<Map<String, String>>> fetchArticles() async {
  try {
    ...
    if (snapshot.docs.isEmpty) {
      print("⚠️ No articles found! Firestore collection might be empty.");
      return [];
    }
    ...
    return snapshot.docs.map((doc) {
      ...
      if (data == null) {
        print("⚠️ Data is null for document: ${doc.id}");
